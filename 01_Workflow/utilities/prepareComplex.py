...
complex_structure.save(f'{output_reference}/{lig_id}.inpcrd', overwrite=True)
complex_structure.save(f'{output_reference}/{lig_base}.prmtop', overwrite=True)
