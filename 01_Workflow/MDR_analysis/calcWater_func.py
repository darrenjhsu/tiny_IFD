...
#if len(sys.argv) < 3:
#	print("Usage: python calcWater.py <input> <output>")
#	exit()
...
def calcWater(inItem, outFile=None, outResname='HOH', printTiming=False, printResult=False, processFrame=0, returnNumWater=False):
